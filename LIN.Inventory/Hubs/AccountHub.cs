...
public class AccountHub : Hub
{
    ...
    public async void ReceiveTestStatus(int account, int battery, bool bateryConected)
    {
        ...
        {
            ServerLogger.LogError("Account HUB: " + ex.Message);
        }
    ...
    public async Task AddContact(string groupName, int contactID)
    {
        ...
        await Clients.GroupExcept(groupName, new[] { Context.ConnectionId }).SendAsync("SendContact", modelo.Model);
